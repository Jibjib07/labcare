                        ...
                        <div class="table-container">
                            <table class="history-table">
                                ...
                                <tbody>
                                    ...
                                    $query_units = "SELECT room_number, set_tag, unit_id, last_maintenance_date FROM units ORDER BY last_maintenance_date DESC";
                                    $result_units = $conn->query($query_units);

                                    if ($result_units && $result_units->num_rows > 0) {
                                        while ($row = $result_units->fetch_assoc()) {
                                            echo "<tr class='selectable-row' data-unit-id='" . htmlspecialchars($row['unit_id']) . "' data-tag='" . htmlspecialchars($row['set_tag']) . "'>";
                        ...
                        <div class="table-container">
                            <table class="history-table">
                                ...
                                <tbody>
                                    ...
                                    $query_assets = "SELECT room_number, set_tag, property_id, last_maintenance_date FROM assets ORDER BY last_maintenance_date DESC";
                                    $result_assets = $conn->query($query_assets);

                                    if ($result_assets && $result_assets->num_rows > 0) {
                                        while ($row = $result_assets->fetch_assoc()) {
                                            echo "<tr class='selectable-row' data-asset-id='" . htmlspecialchars($row['property_id']) . "' data-tag='" . htmlspecialchars($row['set_tag']) . "'>";
                                            echo "<td>" . htmlspecialchars($row['room_number']) . "</td>";
                                            echo "<td>" . htmlspecialchars($row['set_tag']) . "</td>";
                    ...
                    <div id="retired-units-tab" class="tab-content" style="display: none;">
                        <div class="table-container">
                            <table class="history-table">
                                <thead>
                                    <tr>
                                        <th>Set ID</th><th>Set Tag</th><th>Retirement Date</th><th>Origin Lab</th><th>Status</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php
                    ...
                    <div id="retired-assets-tab" class="tab-content" style="display: none;">
                        <div class="table-container">
                            <table class="history-table">
                                <thead>
                                    <tr>
                                        <th>Property ID</th><th>Set Tag</th><th>Retirement Date</th><th>Origin Lab</th><th>Status</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php
