...
try {
    ...
    if ($row = $result->fetch_assoc()) {
        ...
        // =========================================================
        $history_data = [];
        $hist_stmt = $conn->prepare("SELECT report_date, report_actor, report_affected, report_remarks, report_status FROM unit_history WHERE set_id = ? ORDER BY report_date DESC LIMIT 5");
