...
if (isset($_GET['id']) && isset($_GET['type'])) {
    ...
    if (!$foundData) {
        $colSpan = ($type === 'inventory') ? 5 : 6;
        echo "<tr class='no-data-row'><td colspan='{$colSpan}'>No activity history found for this item.</td></tr>";
    }
    exit;
}
            ...
            <div class="split-layout">
                ...
                <div class="panel white-panel right-panel">
                        ...
                        <div class="table-container">
                            <table class="timeline-table">
                                ...
                                <tbody class="data-body">
                                    <tr class="placeholder-row"><td colspan="6" style="text-align: center; padding: 40px; color: #757575;"><em>Select an item on the left to view history.</em></td></tr>
                                </tbody>
                            </table>
                        </div>
                    </div>
                    ...
                    <div id="view-retired-timeline" class="history-view" style="display: none;">
                        ...
                        <div class="table-container">
                            <table class="timeline-table">
                                <thead id="retired-thead">
                                    <tr><th>Date</th><th>By</th><th>Affected</th><th>Action</th><th>Remarks</th><th>Status</th></tr>
                                </thead>
                                <tbody class="data-body">
                                    <tr class="placeholder-row"><td colspan="6" style="text-align: center; padding: 40px; color: #757575;"><em>Select a retired item to view record.</em></td></tr>
                                </tbody>
                            </table>
                        </div>
                    </div>
