...
if (isset($_POST['send_link_btn'])) {
    ...
    if ($user) {
        ...
        $resetLink = "http://localhost/labcare/password_resets.php?token=" . $rawToken;
        ...
        try {
            ...
            $mail->SMTPAuth = true;
            $mail->Username = 'cvsuccclabcare26@gmail.com';  // Labcare Email 
            $mail->Password = 'ftla jdqz yifw jejl';       // Gmail App Password or Your secret 16-char code from Labcare Email
            $mail->SMTPSecure = 'tls';
            $mail->Port = 587;
