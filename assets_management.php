...
<head>
    ...
    <style>
        ...
        .tab-content, .modal-tab-content { animation: fadeIn 0.3s ease-in-out; }
    </style>
</head>
<body>
                    ...
                    <div class="specs-content-box">
                        ...
                        <div id="tab-identity" class="tab-content">
                            <div class="detail-grid-row">
                                <div class="detail-group"><label>Property ID</label><div class="detail-box">1025478521</div></div>
                                <div class="detail-group"><label>Processor (CPU)</label><div class="detail-box">Intel Core i5-12400</div></div>
                            </div>
                            <div class="detail-grid-row">
                                <div class="detail-group"><label>Brand</label><div class="detail-box">Asus</div></div>
                                <div class="detail-group"><label>Operating System</label><div class="detail-box">Windows 11 Pro</div></div>
                            </div>
                            <div class="detail-grid-row">
                                <div class="detail-group"><label>Purchase Date</label><div class="detail-box">11/20/2025</div></div>
                                <div class="detail-group"><label>Graphics Card (GPU)</label><div class="detail-box">Integrated Intel UHD Graphics 730</div></div>
                            </div>
                            <div class="detail-grid-row">
                                <div class="detail-group"><label>Room Number</label><div class="detail-box">104</div></div>
                                <div class="detail-group"><label>RAM (Installed Memory)</label><div class="detail-box">16 GB</div></div>
                            </div>
                            <div class="detail-grid-row">
                                <div class="detail-group"><label>Unit Number</label><div class="detail-box">01</div></div>
                                <div class="detail-group"><label>Storage Type</label><div class="detail-box">SSD (M.2 NVMe)</div></div>
                            </div>
                            <div class="detail-grid-row">
                                <div class="detail-group"></div>
                                <div class="detail-group"><label>Storage Capacity</label><div class="detail-box">512 GB</div></div>
                            </div>
                        </div>
                        ...
                        <div id="tab-external" class="tab-content" style="display: none;">
                            <div class="detail-grid-row">
                                <div class="detail-group">
                                    ...
                                    <div class="sub-detail-row"><span>Available Ports:</span> <div class="detail-box small-box">8</div></div>
                                </div>
                                <div class="detail-group">
                        ...
                        <div id="tab-health" class="tab-content" style="display: none;">
                            <div class="detail-grid-row">
                                <div class="detail-group">
                                    ...
                                    <div class="sub-detail-row"><span>Total:</span> <div class="detail-box small-box">7 Years</div></div>
                                </div>
                                <div class="detail-group">
                            ...
                            <div class="detail-grid-row">
                                <div class="detail-group">
                                    ...
                                    <div class="sub-detail-row"><span>Total:</span> <div class="detail-box small-box">8</div></div>
                                </div>
                                <div class="detail-group">
                            ...
                            <div class="activity-section">
                                ...
                                <table class="activity-table">
                                    <thead><tr><th>Date</th><th>Reported by</th><th>Affected</th><th>Remarks</th><th>Status</th></tr></thead>
                                    <tbody>
                                        <tr>
                                            <td>11/19/2025</td>
                                            <td>Juan Dela Cruz</td>
                                            <td><ul class="table-list"><li>Monitor</li><li>System Unit</li></ul></td>
            ...
            <div class="split-layout">
                ...
                <div class="panel white-panel right-panel">
                    ...
                    <div class="detail-content">
                        <div class="detail-grid-row"><div class="detail-group"><label>Property ID:</label><div class="detail-box">10284521</div></div></div>
                        <div class="detail-grid-row"><div class="detail-group"><label>Brand:</label><div class="detail-box">Acer</div></div></div>
                        <div class="detail-grid-row"><div class="detail-group"><label>Status:</label><div class="detail-box status-box-green">Working</div></div></div>
                    </div>
                </div>
            </div>
        </div>
